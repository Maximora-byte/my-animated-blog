...
export default function LoginPage() {
  ...
  const isPasswordField = focusedField === 'password';
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            <h1 className="text-2xl font-bold text-center mt-4 mb-1 text-gray-800">欢迎回来！</h1>
            <p className="text-gray-500 text-center mb-6 text-sm">登录以继续阅读博客</p>
          </motion.div>
